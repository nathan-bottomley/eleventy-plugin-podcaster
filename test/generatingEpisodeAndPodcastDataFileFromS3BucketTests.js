...
const fixture = './fixtures/generatingEpisodeAndPodcastDatafilesFromS3Bucket'
const s3BucketEpisodeDataPath = path.join(process.cwd(), 'fixtures/s3Buckets/noEpisodeData/episodeData.json')
