...
const s3BucketEpisodeDataPath = path.join(process.cwd(), 'fixtures/s3Buckets/badEpisodeData/episodeData.json')
...
test.serial('the `episodeData.json` file in the S3 bucket is correct', async (t) => {
